...
if (isset($_POST['login_user'])) {
  ...
  if (count($errors) == 0) {
    ...
    if (mysqli_num_rows($results) == 1) {
      ...
      header("location:home.php?info=add_club");
    }else {
...
<div class="container-fluid">
  <a class="navbar-brand" href="index.php"><h3><b>HEALTH CLUB MANAGEMENT</b></h3></a>
 
</div>
</nav>

 <h2 style="color:white; text-align:center;"><b> Access Only To Admin</b></h2>
