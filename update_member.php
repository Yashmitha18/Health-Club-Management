...
if (isset($_REQUEST['member'])) {
  ...
  $update_query="update member set mem_id='$mem_id',name='$name',age='$age',dob='$dob',package='$package',mobileno='$mobileno',class_id='$class_id' where mem_id='".$_GET['id']."'";
...
<div class="container">
    ...
    ?>
		...
		<input type="text" name="class_id" value="<?php echo @$res['class_id'];?>" class="form-control">
